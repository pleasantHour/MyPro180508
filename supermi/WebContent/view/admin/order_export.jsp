        ...
        <div class="row">
            <div class="col-sm-12" style="width:2000px;">
                <div class="ibox float-e-margins">
                        ...
                        <table class="table table-striped table-bordered table-hover dataTables-example">
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align: center;" >供货价</th>
                            ...
                            <tbody>
                            	<tr class="gradeX">
                                    ...
                                    <td style="text-align: center;">已完成支付</td>
                                    <td  style="text-align: center;" >2017-11-26</td>
                                    <td  style="text-align: center;" >2017-11-26</td>
                                    <td style="text-align: center;"><span class="label label-primary">已支付</span></td>
                    ...
                    <a href="" style=" margin-top:20px;float:left; width:180px; line-height:35px; background:#23b7e5; color: #fff; text-align:center; border-radius:5px; font-size:14px; font-weight:bold;">导出订单</a>
                </div>
            </div>
        </div>
    </div>
